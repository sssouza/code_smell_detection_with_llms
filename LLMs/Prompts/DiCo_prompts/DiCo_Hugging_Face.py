...
def analyze_java_files_to_csv_hf(
    ...
    user_template: str = """
        ...
        Instructions:
        If you detect symptoms that could indicate Dispersed Coupling, answer only with "YES, I found Dispersed Coupling". If you do not, answer only with "NO, I did not find Dispersed Coupling". Do not provide any reasoning or explanation.
...
if __name__ == "__main__":
    ...
    CSV_OUTPUT = r"YOUR_DESTINY_FOLDER/deepseekR1_analysis_DiCo.csv"
