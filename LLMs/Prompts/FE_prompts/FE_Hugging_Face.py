...
def analyze_java_files_to_csv_hf(
    ...
    user_template: str = """
        ...
        Instructions:
        Please finish your answer with "YES, I found Feature Envy" if you detect symptoms that could indicate this smell, or "NO, I did not find Feature Envy" if you do not. Briefly explain your reasoning, answer the questions and provide the summary as instructed.  
...
if __name__ == "__main__":
    ...
    CSV_OUTPUT = r"YOUR_DESTINY_FOLDER/deepseekR1_analysis_FE.csv"
